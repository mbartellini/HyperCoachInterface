    ...
    <v-row class="d-flex justify-center align-content-center">
      ...
      >
        <v-row fluid class="d-flex justify-center">
          <v-col cols="2">
            <v-btn fab color="error" class="d-flex justify-center">
              <v-icon>
                mdi-delete
              </v-icon>
            </v-btn>
